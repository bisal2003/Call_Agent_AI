...
def transcribe_audio(audio_path):
    ...
    config = speech.RecognitionConfig(
        encoding=speech.RecognitionConfig.AudioEncoding.LINEAR16,  # Audio format
        sample_rate_hertz=16000,  # Sample rate of the audio file
        language_code="en-US",  # Language code (English in this case)
    )
...
# Example usage: replace 'your_audio_file.wav' with the path to your audio file
