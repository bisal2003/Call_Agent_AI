...
def main():
    ...
    while True:
        ...
        start = time.time()
        response = sales_conversation(salesperson_name, salesperson_role, company_name, company_business, company_values, conversation_purpose, conversation_type,conversation_history)
